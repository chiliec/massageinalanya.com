...
const translations = {
  ...
  cta: {
    ...
    ru: {
      ...
      body: "Из-за плотного клинического графика я не использую автоматические системы бронирования. Каждый случай уникален, и мне важно понять ваши конкретные потребности до вашего визита в клинику.",
